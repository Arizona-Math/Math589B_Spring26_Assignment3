...
two functions:
\begin{enumerate}
\item \texttt{solve_continuous_are}
\item \texttt{solve_ivp}
\end{enumerate}
Make sure that the signatures of these functions and values returned
correspond to their usage in the file \texttt{modal_lqr.py}.

The Gradescope Autograder will call your implementation
through functions:
\begin{enumerate}
  \item \texttt{simulate_closed_loop}
  \item \texttt{simulate_open_loop}
\end{enumerate}
